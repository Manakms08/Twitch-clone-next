    ...
    <div className='p-2 md:p-8'>
      ...
      <div className='grid sm:grid-cols-3 lg:grid-cols-5 gap-4 border-t border-gray-700 py-8'>
       ...
       <div className='w-full h-[50px] bg-[#9147ff] flex justify-between items-center px-4 rounded '>
          <p className='2xl font-bold'>Games</p>
          <Image src={Remote} alt='/'></Image>
       </div>
       {/*Grid Item*/}
       <div className='w-full h-[50px] bg-[#9147ff] flex justify-between items-center px-4 rounded '>
          <p className='2xl font-bold'>IRL</p>
          <Image src={Mic} alt='/'></Image>
       </div>
       {/*Grid Item*/}
       <div className='w-full h-[50px] bg-[#9147ff] flex justify-between items-center px-4 rounded '>
          <p className='2xl font-bold'>Music</p>
          <Image src={Headphones} alt='/'></Image>
       </div>
       {/*Grid Item*/}
       <div className='w-full h-[50px] bg-[#9147ff] flex justify-between items-center px-4 rounded '>
          <p className='2xl font-bold'>Esports</p>
          <Image src={Trophy} alt='/'></Image>
       </div>
       {/*Grid Item*/}
       <div className='w-full h-[50px] bg-[#9147ff] flex justify-between items-center px-4 rounded '>
          <p className='2xl font-bold'>Creative</p>
          <Image src={Paint} alt='/'></Image>
       </div>
      </div>  
    </div>
  )
